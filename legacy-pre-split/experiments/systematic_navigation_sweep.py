...
from commutativity_probe import Environment
...
OBSERVATION_MODES = ("vector", "sparse_aliased")
HISTORY_LENGTH = 8
RNN_HIDDEN_DIM = 32
...
def room_graph_environment(topology: str, size: int = ROOM_SIZE) -> Environment:
    ...
    return Environment(f"room_graph_{topology}", states, actions, transition, frozenset(valid))
