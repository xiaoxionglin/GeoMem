...
The detailed rows are in `figures/rnn_lin_long_sequence_summary.csv`. The family-level winner table is in `figures/rnn_lin_long_architecture_families.csv`, and `figures/rnn_lin_long_architecture_comparison.svg` visualizes all long-task models.

![](../figures/rnn_lin_long_architecture_comparison.svg)
