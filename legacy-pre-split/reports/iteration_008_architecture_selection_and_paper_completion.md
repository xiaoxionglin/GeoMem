...
- `modules/memory_architecture.md`;
- `modules/biological_predictions.md`;
- `experiments/architecture_selection.py`;
- `figures/architecture_selection.csv`;
- `figures/architecture_selection_summary.md`;
