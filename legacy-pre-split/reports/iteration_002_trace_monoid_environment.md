...
Added a trace-monoid action-history environment to `experiments/commutativity_probe.py`.
...
![](../figures/commutator_matrix_trace_commute_000_valid.svg)

![](../figures/commutator_matrix_trace_commute_100_valid.svg)
