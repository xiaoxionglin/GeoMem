...
Added `experiments/supervised_policy_benchmark.py`.
...
![](../figures/supervised_policy_all_lookup_optimal_action_accuracy.svg)

![](../figures/supervised_policy_random70_decision_tree_optimal_action_accuracy.svg)
