...
```text
T(o, a) = |{s' : exists s with O(s)=o and P(s'|s,a)>0}|
```
...
See `../literature/bibliography.md` for the working bibliography. The manuscript should prioritize Lin/Yiu/Leibold 2026, Leibold 2020, Yiu/Leibold 2023, Chenani et al. 2019, McNaughton et al. 2006, Peer et al. 2021, Chrastil/Warren 2014, Stachenfeld et al. 2017, Whittington et al. 2020, George et al. 2021/2024, and Banino et al. 2018.
