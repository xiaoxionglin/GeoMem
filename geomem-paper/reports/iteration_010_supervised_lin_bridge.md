...
- `../../geomem-experiments/figures/rnn_lin_sequence_summary.csv`;
- `../../geomem-experiments/figures/rnn_lin_sequence_injection.csv`;
- `../../geomem-experiments/figures/rnn_lin_sequence_grid.svg`;
- `../../geomem-experiments/figures/rnn_navigation_egocentric_landmark_*`.

![](../../geomem-experiments/figures/rnn_lin_sequence_grid.svg)

![](../../geomem-experiments/figures/rnn_navigation_egocentric_landmark_accuracy.svg)
