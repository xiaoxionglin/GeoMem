...
Added `../../geomem-experiments/experiments/lightweight_empirical_benchmark.py`.
...
- `../../geomem-experiments/figures/lightweight_empirical_benchmark.csv`;
- `../../geomem-experiments/figures/lightweight_sparsity_commutativity.svg`;
...
- `../../geomem-experiments/figures/lightweight_memory_capacity.svg`.
