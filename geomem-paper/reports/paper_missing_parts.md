...
| --------------------------------------------- | ------ | ------------------------------------------------------------------------------------------------ |
| Explicit memory-architecture theory           | Done   | `../../geomem-theory/modules/memory_architecture.md`                                                                 |
| Formal theory package and full proof appendix | Done   | `../../geomem-theory/modules/formal_theory.md`, `../manuscript/theory_appendix.md`                                      |
| Biological prediction table                   | Done   | `../../legacy-pre-split/modules/biological_predictions.md`                                                              |
| Cost-aware architecture selection result      | Done   | `../../geomem-experiments/experiments/architecture_selection.py`, `../../geomem-experiments/figures/architecture_selection.*`                      |
| Multi-goal robustness                         | Done   | `../../geomem-experiments/experiments/lightweight_empirical_benchmark.py`                                                 |
| Paper-structured draft                        | Done   | `../manuscript/paper_draft.md`                                                                      |
| Reviewer-facing critique file                 | Done   | `reviewer_opinion.md`                                                                    |
| Supervised behavioral Lin bridge              | Done   | delayed-route tasks and `R/L/ell` sequence readouts in `../../geomem-experiments/experiments/rnn_navigation_benchmark.py` |
| Systematic paper-first sweeps                 | Done   | `../../geomem-experiments/experiments/systematic_formal_sweep.py`, `../../geomem-experiments/experiments/systematic_navigation_sweep.py`, `../../geomem-experiments/experiments/delay_span_sweep.py`            |
