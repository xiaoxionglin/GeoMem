...
- `../../geomem-experiments/experiments/recurrent_matrix_analysis.py`;
- `../../geomem-experiments/figures/rnn_navigation_benchmark.csv`;
- `../../geomem-experiments/figures/rnn_navigation_summary.csv`;
- `../../geomem-experiments/figures/rnn_memory_advantage.csv`;
- `../../geomem-experiments/figures/rnn_temporal_sparsity_summary.csv`;
- `../../geomem-experiments/figures/rnn_temporal_sparsity_advantage.csv`;
- `../../geomem-experiments/figures/rnn_weight_analysis.csv`;
- `../../geomem-experiments/figures/reservoir_matrix_analysis.csv`;
- `../../geomem-experiments/figures/rnn_navigation_*_accuracy.svg`;
- `../../geomem-experiments/figures/rnn_navigation_*_success.svg`;
- `../../geomem-experiments/figures/rnn_memory_advantage.svg`;
- `../../geomem-experiments/figures/rnn_temporal_sparsity_reservoirs.svg`;
- `../../geomem-experiments/figures/reservoir_matrix_analysis.svg`.
...
![](../../geomem-experiments/figures/rnn_navigation_sparse_aliased_accuracy.svg)
