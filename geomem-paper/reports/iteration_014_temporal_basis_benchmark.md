...
status: evaluated
related:
  - "../../geomem-theory/theory/oscillatory_contraction_vs_nilpotent_forgetting.md"
  - "../../geomem-theory/theory/lin_block_advantage.md"
---
...
`../../geomem-experiments/experiments/temporal_basis_benchmark.py` compares:
...
- `../../geomem-experiments/figures/temporal_basis_delayed_cue.csv`
- `../../geomem-experiments/figures/temporal_basis_phase_task.csv`
